...
describe('Auth Schemas', () => {
  ...
  describe('registerSchema', () => {
    ...
    it('should reject passwords without uppercase letters', () => {
      ...
      if (!result.success) {
        expect(result.error.format().password?._errors).toContain('Hasło musi zawierać przynajmniej jedną wielką literę');
      }
    });
    ...
    it('should reject passwords without special characters', () => {
      ...
      if (!result.success) {
        expect(result.error.format().password?._errors).toContain('Hasło musi zawierać przynajmniej jeden znak specjalny');
      }
    });
  });
